      ...
      <div className="h-full flex flex-col">
        ...
        <nav className="flex-1 px-3 py-6 space-y-2">
          {navItems.map(item => (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition-all duration-200 group relative overflow-hidden ${activeModule === item.id
        ...
        <div className={`p-4 border-t space-y-2 ${isDark ? 'border-slate-800' : 'border-slate-100'}`}>
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition-colors ${activeModule === 'settings'
