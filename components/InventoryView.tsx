        ...
        >
            <div className="flex justify-between items-start gap-2">
                <div className="min-w-0">
                    <h3 className={`text-[15px] font-semibold leading-tight group-hover:text-[#0077B5] transition-colors line-clamp-2 min-h-[40px] ${isDark ? 'text-slate-100' : 'text-[#313335]'
                        }`}>
                        {item.name}
                    </h3>
                    <div className="mt-2 flex items-center gap-2 text-[11px] font-medium flex-wrap">
                        <span className={`px-1.5 py-0.5 rounded border transition-colors ${isDark ? 'bg-slate-900 border-slate-700 text-slate-500' : 'bg-[#CACCCE]/20 border-[#CACCCE] text-[#86888A]'
                            }`}>#{item.sku}</span>
                ...
                <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-1.5">
                        <button
                            ...
                            className={`w-9 h-9 flex items-center justify-center rounded-lg transition-all active:scale-90 ${isDark ? 'bg-slate-700/50 text-slate-300 hover:bg-red-500/20 hover:text-red-400' : 'bg-[#CACCCE]/30 text-[#313335] hover:bg-red-50 hover:text-red-600'
                                }`}
                        >
                            <Minus size={18} />
                        </button>
                        <button
                            onClick={(e) => handleClick(e, 1)}
                            className={`w-9 h-9 flex items-center justify-center rounded-lg transition-all active:scale-90 ${isDark ? 'bg-slate-700/50 text-slate-300 hover:bg-emerald-500/20 hover:text-emerald-400' : 'bg-[#CACCCE]/30 text-[#313335] hover:bg-emerald-50 hover:text-emerald-600'
                                }`}
                        >
                            <Plus size={18} />
                        </button>
                    ...
                    <div className="flex-1 flex items-center gap-1">
                        ...
                        <div className="flex flex-col gap-1">
                            <button
                                onClick={(e) => handleClick(e, 1)}
                                className={`px-2 py-0.5 text-[10px] font-bold rounded uppercase transition-colors ${isDark ? 'bg-slate-700 hover:bg-slate-600 text-slate-300' : 'bg-[#0077B5] hover:bg-[#00A0DC] text-white'
                                    }`}
                            >
                                Add
                            </button>
                            <button
                                onClick={(e) => handleClick(e, -1)}
                                className={`px-2 py-0.5 text-[10px] font-bold rounded uppercase transition-colors ${isDark ? 'bg-slate-700 hover:bg-slate-600 text-slate-300' : 'bg-[#313335] hover:bg-[#000000] text-white'
                                    }`}
                            >
                                Rem
                            </button>
    ...
    return (
        <div className="h-full flex flex-col animate-in fade-in slide-in-from-right-8 duration-300">
            ...
            <div className="mb-6 flex gap-4">
                ...
                <button
                    className={`hidden md:flex px-6 rounded-2xl border items-center justify-center gap-2 font-bold transition-all ${isDark ? 'bg-slate-900 border-slate-800 text-slate-400 hover:bg-slate-800' : 'bg-white border-slate-200 text-slate-500 hover:bg-slate-50'
                        }`}
                >
